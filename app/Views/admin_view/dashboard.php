    ...
    <div class="content container-fluid">
        ...
        <div class="row">
            <div class="col-xl-3 col-sm-6 col-12 d-flex">
                <div class="card bg-comman-siswa w-100">
                    <div class="card-body">
                        <div class="db-widgets d-flex justify-content-between align-items-center">
                            ...
                            <div class="db-icon">
                                <img src="<?php echo base_url('theme'); ?>/assets/img/icons/dash-icon-01.svg"
                                    alt="Dashboard Icon">
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-xl-3 col-sm-6 col-12 d-flex">
                <div class="card bg-comman-guru w-100">
                    <div class="card-body">
                        <div class="db-widgets d-flex justify-content-between align-items-center">
                            <div class="db-info">
                                <h6>Guru</h6>
                            ...
                            <div class="db-icon">
                                <img src="<?php echo base_url('theme'); ?>/assets/img/img_real/guru.png"
                                    alt="Dashboard Icon" width="70px">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-3 col-sm-6 col-12 d-flex">
                <div class="card bg-comman-smasuk w-100">
                    <div class="card-body">
                        <div class="db-widgets d-flex justify-content-between align-items-center">
                            <div class="db-info">
                                <h6>Surat Masuk</h6>
                            ...
                            <div class="db-icon">
                                <img src="<?php echo base_url('theme'); ?>/assets/img/icons/dash-icon-03.svg"
                                    alt="Dashboard Icon">
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-xl-3 col-sm-6 col-12 d-flex">
                <div class="card bg-comman-skeluar w-100">
                    <div class="card-body">
                        <div class="db-widgets d-flex justify-content-between align-items-center">
                            <div class="db-info">
                                <h6>Surat Keluar</h6>
                ...
                <div class="card bg-comman w-100">
                    <div class="card-body">
                        <div class="db-widgets d-flex justify-content-between align-items-center">
                            ...
                            <div class="db-icon">
                                <img src="<?php echo base_url('theme'); ?>/assets/img/img_real/tgl.png"
                                    alt="Dashboard Icon" width="70px">
                            </div>
                        </div>
                    </div>
