        ...
        <div class="sidebar-inner slimscroll">
            <div id="sidebar-menu" class="sidebar-menu">
                <ul>
                    ...
                    <li class="menu">
                        <a href="<?php echo base_url('ruang'); ?>"><i class="fas fa-graduation-cap"></i> <span>
                                Management Ruang</span></span></a>
                    </li>
                    <li class="menu">
                        <a href="<?php echo base_url('mapel'); ?>"><i class="fas fa-chalkboard-teacher"></i>
                            <span>Management Mapel</span></span></a>
                    </li>
                    <li class="menu">
                        <a href="<?php echo base_url('absen_tu'); ?>"><i class="fas fa-book-reader"></i> <span>Data
                                Absensi Siswa</span></span></a>
                    </li>
                    <li class="menu">
                        <a href="<?php echo base_url('jadwal'); ?>"><i class="fas fa-book-reader"></i> <span>
                                Penjadwalan </span></span></a>
                    </li>
                    <li class="menu">
                        <a href="<?php echo base_url('regalisir'); ?>"><i class="fas fa-building"></i> <span>Status
                                Regalisir </span></span></a>
                    </li>
                    <li class="submenu">
                        <a href="#"><i class="fas fa-marker"></i> <span> Management Nilai </span> <span
                    ...
                    <li class="submenu">
                        <a href="#"><i class="fas fa-clipboard"></i> <span> Management Surat</span> <span
                                class="menu-arrow"></span></a>
                        <ul>
                    ...
                    <li class="menu">
                        <a href="<?php echo base_url('user_tu'); ?>"><i class="fas fa-solid fa-user"></i></i> <span>
                                User</span></span></a>
                    </li>
                </ul>
            </div>
