<<?php echo view('admin_view/partials/header') ?> <<?php echo view('admin_view/partials/sidebar') ?> <div
    class="page-wrapper">
                        ...
                        <div class="page-header">
                            <div class="row align-items-center">
                                ...
                                <div class="col-auto text-end float-end ms-auto download-grp">
                                    ...
                                    <a href="<?php echo base_url('surat_masuk/create_surat'); ?>"
                            ...
                            <table
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <a href="<?php echo base_url('surat_masuk/show_masuk/' . $row['id_surat']); ?>"
                                                    class="btn btn-sm btn-info">
                                                    <i class="fa fa-eye"></i>
                                                </a>
                                                <a href="<?php echo base_url('surat_masuk/edit/' . $row['id_surat']); ?>"
                                                    class="btn btn-sm btn-success">
                                                    <i class="fa fa-edit"></i>
                                                </a>
                                                <a href="<?php echo base_url('surat_masuk/delete/' . $row['id_surat']); ?>"
